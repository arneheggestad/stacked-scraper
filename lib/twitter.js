...
var twitter = {
  ...
  generateOauthData: function (callback) {
    var oauthData = {};
  ...
  generateSignature: function (oauthData, callback) {
    ...
    if (oauthData.consumerKey) {
      consumerKey = oauthData.consumerKey;
    }
    if (oauthData.consumerSecret) {
    ...
    var signingKey = encodeURIComponent(consumerSecret) + '&' + encodeURIComponent(oauthData.tokenSecret);
    // HMAC-SHA1 signing
