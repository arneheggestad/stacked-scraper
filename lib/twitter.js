...
var twitter = {
  ...
  doOauthQuery: function (user, callback) {
    console.log('doOauthQuery called');
    ...
    oauth.get(
      ...
      user.userTokenSecret, // user secret
  ...
  getPosts: function (twitterUsers, cb) {
    var responses = {},
    ...
    async.each(users, function (userId, callback) {
      ...
      twitter.doOauthQuery (user, function (err, data) {
        if (err) { console.log('error: ' + err); }
        console.log(userId, ': found posts');
        callback (null, userId, data);
      });
    }, function (err, userId, data) {
      if (err) {
        console.log (err);
      }
      console.log(data);
      responses[ userId ] = data;
    });
    cb (null, responses);
  }
}
